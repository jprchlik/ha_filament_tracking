...
for i,j in enumerate(fil['track_id']):
    ...
    #if fil['num_inst'][i] > 3:
    ### only include filaments that track all the way across the solar disk
    if j in good_ids:
...
for i,j in enumerate(tilts3_n):
    abs_tilts3_n.append(abs(j))
for i,j in enumerate(tilts3_s):
    abs_tilts3_s.append(abs(j))
...
###############################################################################
######################## Categories 1 and 2 -- NO 3 ###########################
###############################################################################         
### create a list of cat1, 2, and 3 lengths together
lengths12 = lengths1 + lengths2
tilts12 = tilts1 + tilts2
abs_tilts12 = abs_tilts1 + abs_tilts2
lats12_nan = lats1 + lats2
tilts12_n = tilts1_n + tilts2_n
tilts12_s = tilts1_s + tilts2_s

lengths12_n = lengths1_n + lengths2_n
lengths12_s = lengths1_s + lengths2_s

abs_tilts12_n = abs_tilts1_n + abs_tilts2_n
abs_tilts12_s = abs_tilts1_s + abs_tilts2_s
...
tilts12_alt = []
lengths12_alt = []
for i,j in enumerate(lats12_nan):
    if str(j) != 'nan':
        lats12.append(j)
        tilts12_alt.append(tilts12[i])
        lengths12_alt.append(lengths12[i])
    
lats12_deg = []
for i,j in enumerate(lats12):
    x,y = sunpy.wcs.convert_hpc_hg(0,j)
    lats12_deg.append(y)

abs_lats12_deg = []
for i,j in enumerate(lats12_deg):
    abs_lats12_deg.append(abs(j))
...
ax0.hist(lengths12, bins=hist_bins, color='blue', alpha = 0.5)
...
ax0.set_ylim([0,40])
blue_patch = Patch(color='blue', alpha = 0.5, label='Categories 1 and 2')
green_patch = Patch(color='green', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[blue_patch,green_patch])
fig.savefig("Length_Hist_12v4.png",bbox_pad=.1,bbox_inches='tight', label='Category 4')
plt.show()
...
N12 = len(lengths12)
N4 = len(lengths4)
plt.plot(np.sort(lengths12), np.array(range(N12))/float(N12), color='blue', label='Categories 1 and 2')
plt.plot(np.sort(lengths4), np.array(range(N4))/float(N4), color='green', label='Category 4')
ax1.set_title('Filament Length')
ax1.set_xlabel('Length (cm)')
ax1.set_ylim([0,1.38])
blue_patch = Patch(color='blue', alpha = 0.5, label='Categories 1 and 2')
green_patch = Patch(color='green', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[blue_patch,green_patch])
fig.savefig("Length_CDF_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()

stat,crit,sig = stats.anderson_ksamp([lengths12,lengths4])
print stat
print sig
...
### Tilt Histogram 12 v 4, NORTH and SOUTH

fig, ax2 = plt.subplots()
ax2.hist(tilts12_n, bins=hist_bins, color='darkblue', alpha = 0.5, label='Categories 1 and 2')
ax2.hist(tilts4_n, bins=hist_bins, color='purple', alpha = 0.5, label='Category 4')
ax2.set_title('Filament Tilt: Northern Hemisphere')
ax2.set_xlabel('Tilt Angle (degrees)')
#ax2.set_ylabel('Total #')
ax2.set_ylim([0,11])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Tilt_Hist__North_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()

fig, ax2 = plt.subplots()
ax2.hist(tilts12_s, bins=hist_bins, color='darkblue', alpha = 0.5, label='Categories 1 and 2')
ax2.hist(tilts4_s, bins=hist_bins, color='purple', alpha = 0.5, label='Category 4')
ax2.set_title('Filament Tilt: Southern Hemisphere')
ax2.set_xlabel('Tilt Angle (degrees)')
#ax2.set_ylabel('Total #')
ax2.set_ylim([0,27])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Tilt_Hist__South_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
fig, ax2 = plt.subplots()
ax2.hist(tilts12, bins=hist_bins, color='darkblue', alpha = 0.5, label='Categories 1 and 2')
ax2.hist(tilts4, bins=hist_bins, color='purple', alpha = 0.5, label='Category 4')
ax2.set_title('Filament Tilt')
ax2.set_xlabel('Tilt Angle (degrees)')
#ax2.set_ylabel('Total #')
ax2.set_ylim([0,27])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Tilt_Hist_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
N12 = len(tilts12)
N4 = len(tilts4)
plt.plot(np.sort(tilts12), np.array(range(N12))/float(N12), color='darkblue', label='Categories 1 and 2')
plt.plot(np.sort(tilts4), np.array(range(N4))/float(N4), color='purple', label='Category 4')
ax3.set_title('Filament Tilt')
ax3.set_xlabel('Tilt Angle (degrees)')
ax3.set_ylim([0,1.35])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Tilt_CDF_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()

stat,crit,sig = stats.anderson_ksamp([tilts12,tilts4])
print stat
print sig

### Median latitude histograms: 123 vs 4
fig, ax4 = plt.subplots()
ax4.hist(lats12_deg, bins=hist_bins, color='darkblue', alpha = 0.5, label='Categories 1 and 2')
ax4.hist(lats4_deg, bins=hist_bins, color='purple', alpha = 0.5, label='Category 4')
ax4.set_title('Filament Latitude')
ax4.set_xlabel('Latitude (degrees)')
ax4.set_ylim([0,39])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Lat_Hist_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
N12 = len(lats12_deg)
N4 = len(lats4_deg)
plt.plot(np.sort(lats12_deg), np.array(range(N12))/float(N12), color='darkblue', label='Categories 1 and 2')
plt.plot(np.sort(lats4_deg), np.array(range(N4))/float(N4), color='purple', label='Category 4')
ax5.set_title('Filament Latitude')
ax5.set_xlabel('Latitude (degrees)')
ax5.set_ylim([0,1.35])
darkblue_patch = Patch(color='darkblue', alpha = 0.5, label='Categories 1 and 2')
purple_patch = Patch(color='purple', alpha = 0.5, label='Category 4')
plt.legend(frameon=False, handles=[darkblue_patch,purple_patch])
fig.savefig("Lat_CDF_12v4.png",bbox_pad=.1,bbox_inches='tight')
plt.show()

stat,crit,sig = stats.anderson_ksamp([lats12,lats4])
print stat
print sig
...
fig.suptitle("Latitude vs. Length", fontsize=28, x = 1, y = 3.25)
                
ax[0,0].scatter(abs_lats1, lengths1_alt)
ax[0,0].set_xlabel('Median Latitude (degrees)',fontsize=24)
ax[0,0].set_ylabel('Median Length (cm)',fontsize=24)
ax[0,0].set_title('Category 1',fontsize=28)
...
ax[0,1].set_xlabel('Median Latitude (degrees)',fontsize=24)
ax[0,1].set_ylabel('Median Length (cm)',fontsize=24)
ax[0,1].set_title('Category 2',fontsize=28)
...
print corr
#fig, ax3 = plt.subplots()
ax[1,0].scatter(abs_lats12_deg, lengths12_alt)
ax[1,0].set_xlabel('Median Latitude (degrees)',fontsize=24)
ax[1,0].set_ylabel('Median Length (cm)',fontsize=24)
ax[1,0].set_title('Categories 1 and 2',fontsize=28)
ax[1,0].set_xlim([0,90])
ax[1,0].set_ylim([0,3.0e10])
...
print corr
#fig, ax4 = plt.subplots()
ax[1,1].scatter(abs_lats4_deg, lengths4_alt)
ax[1,1].set_xlabel('Median Latitude (degrees)',fontsize=24)
ax[1,1].set_ylabel('Median Length (cm)',fontsize=24)
ax[1,1].set_title('Category 4',fontsize=2)
...
fig.savefig("AbsLat_Length_12v4.png",bbox_pad=.1,bbox_inches='tight')
...
fig, ax = plt.subplots(nrows=2, ncols=2)
fig.subplots_adjust(left  = 0, right = 2, bottom = 0, top = 3, wspace = 0.2, hspace = 0.3)
fig.suptitle("Latitude vs. Tilt", fontsize=22, x = 1, y = 3.25)
...
print corr
#fig, ax = plt.subplots()
ax[0,1].scatter(abs_lats2, tilts2_alt)
...
corr,pval = stats.pearsonr(abs_lats12_deg, tilts12_alt)
print corr
#fig, ax = plt.subplots()
ax[1,0].scatter(abs_lats12_deg, tilts12_alt)
ax[1,0].set_xlabel('Median Latitude (degrees)')
ax[1,0].set_ylabel('Median Tilt Angle (degrees)')
ax[1,0].set_title('Categories 1 and 2')
ax[1,0].set_xlim([0,90])
...
fig.savefig("AbsLat_Tilt_12v4.png",bbox_pad=.1,bbox_inches='tight')
...
fig, ax = plt.subplots(nrows=2, ncols=2)
#fig.tight_layout()
fig.subplots_adjust(left  = 0, right = 2, bottom = 0, top = 3, wspace = 0.3, hspace = 0.3) 
fig.suptitle("Latitude vs. Length", fontsize=28, x = 1, y = 3.25)
...
"""
### Scatter plot of median length (12) vs. median latitude (12)
corr,pval = stats.pearsonr(lats12_deg, lengths12_alt)
print corr
#fig, ax = plt.subplots()
ax[1,0].scatter(lats12_deg, lengths12_alt)
ax[1,0].set_xlabel('Median Latitude (degrees)')
ax[1,0].set_ylabel('Median Length (cm)')
ax[1,0].set_title('Categories 1 and 2')
ax[1,0].set_xlim([-90,90])
...
print corr
#fig, ax = plt.subplots()
ax[1,1].scatter(lats4_deg, lengths4_alt)
ax[1,1].set_xlabel('Median Latitude (degrees)')
...
fig.savefig("Lat_Length_12v4.png",bbox_pad=.1,bbox_inches='tight')

fig, ax = plt.subplots(nrows=2, ncols=2)
fig.subplots_adjust(left  = 0, right = 2, bottom = 0, top = 3, wspace = 0.3, hspace = 0.35) 
fig.suptitle("Latitude vs. Tilt", fontsize=28, x = 1, y = 3.25)
...
#fig, ax = plt.subplots()
ax[0,0].scatter(lats1_deg, tilts1_alt, color='k', marker ='o')
...
#fig, ax = plt.subplots()
ax[0,1].scatter(lats2_deg, tilts2_alt, color='k', marker ='o')
...
print corr
#fig, ax = plt.subplots()
ax[1,0].scatter(lats3_deg, tilts3_alt)
ax[1,0].set_xlabel('Median Latitude (degrees)')
ax[1,0].set_ylabel('Median Tilt Angle (degrees)')
...
"""
### Scatter plot of median tilts (123) vs. median latitude (123)
corr,pval = stats.pearsonr(lats12_deg, tilts12_alt)
print corr

med_tilt_n = np.median(tilts12_n)
med_tilt_s = np.median(tilts12_s)

#fig, ax = plt.subplots()
ax[1,0].scatter(lats12_deg, tilts12_alt, color='k', marker ='o')
...
#fig, ax = plt.subplots()
ax[1,1].scatter(lats4_deg, tilts4_alt, color='k', marker ='o')
...
fig.savefig("Lat_Tilt_lines_12v4.png",bbox_pad=.1,bbox_inches='tight')

#%%

###############################################################################
####################### Tilt and Length Scatter Plots #########################
###############################################################################
...
### Scatter plot of median tilts (12) vs. median length (12)
fig, ax = plt.subplots()
ax.plot(tilts12_n, lengths12_n,'bo')
ax.plot(tilts12_s, lengths12_s,'ro')
ax.set_xlabel('Median Tilt Angle (degrees)')
ax.set_ylabel('Median Length (cm)')
ax.set_title('Tilt vs. Length (Categories 1 and 2)')
fig.savefig("Tilt_Length_Scatter_ns12.png",bbox_pad=.1,bbox_inches='tight')
...
fig.savefig("Tilt_Length_Scatter_ns4.png",bbox_pad=.1,bbox_inches='tight')

### Scatter plot of median tilts (123) vs. median length (123)
fig, ax = plt.subplots()
ax.plot(abs_tilts12_n, lengths12_n,'bo')
ax.plot(abs_tilts12_s, lengths12_s,'ro')
ax.set_xlabel('Median Tilt Angle (degrees)')
ax.set_ylabel('Median Length (cm)')
ax.set_title('Absolute Value of Tilt vs. Length (Categories 1 and 2)')
fig.savefig("Abs_Tilt_Length_Scatter_ns12.png",bbox_pad=.1,bbox_inches='tight')
...
fig.savefig("Abs_Tilt_Length_Scatter_ns4.png",bbox_pad=.1,bbox_inches='tight')
...
### list of category 1, 2, and 4 lengths combined
lengths124 = lengths12 + lengths4
...
for i,sbin in enumerate(sbins):
    ...
    filwcav, = np.where((np.asarray(lengths12) >= sbin) & (np.asarray(lengths12) < ebin))
    ### get total number of cavities in bin
    totacav, = np.where((np.asarray(lengths124) >= sbin) & (np.asarray(lengths124) < ebin))
...
mono_lengths = np.linspace(min(lengths124), max(lengths124), len(cav_df['bi_lengths']), endpoint=True)
cav_df['mono_lengths'] = mono_lengths
len_predict = length_result.predict(cav_df[['mono_lengths','intercept_l']])

### plot these point estimates for logistic regression
fig, ax = plt.subplots()
ax.plot(lengths124, bi_lengths, 'bo')
...
fig.savefig("LogReg_Length_Bi_124.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
for i,sbin in enumerate(sbins):
    ...
    if i == len(sbins)-1: 
        ...
        ebin = sbins[i+1]
    ### get where x values are in range and have cavities
    filwcav, = np.where((np.asarray(tilts12) >= sbin) & (np.asarray(tilts12) < ebin))
    ### get total number of cavities in bin
    totacav, = np.where((np.asarray(tilts124) >= sbin) & (np.asarray(tilts124) < ebin))
    ### store values for later
    fbin.append(float(filwcav.size)/float(totacav.size))
    print totacav.size
    cbin.append(sbin + (ebin-sbin)/2.)
...
cav_df['tilts124'] = tilts124
### create an array of constants that hold a place for the intercept 
cav_df['intercept_t'] = [1]*len(tilts124) 
...
mono_tilts = np.linspace(min(tilts124), max(tilts124), len(cav_df['bi_lengths']), endpoint=True)
...
ax.set_ylabel('Proportion of Filaments with Cavities')
fig.savefig("LogReg_Tilt_Bi_124.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
ax.set_xlabel('Length (cm)')
ax.set_ylabel('Proportion of Filaments with Cavities')
fig.savefig("LogReg_Length_Bi.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
...
ax.set_xlabel('Tilt (degrees)')
ax.set_ylabel('Proportion of Filaments with Cavities')
fig.savefig("LogReg_Tilt_Bi.png",bbox_pad=.1,bbox_inches='tight')
plt.show()
